object MainWindow: TMainWindow
  ...
  object MainMenu: TMainMenu
    ...
    object MMFile: TMenuItem
      ...
      object Export_OMERO: TMenuItem
        Caption = 'Exportar a OMERO'
        OnClick = Export_OMEROClick
      end
    end
    object MMAcquisition: TMenuItem
      ...
      object MMASectioning: TMenuItem
        Caption = 'Seccionamiento'
        OnClick = MMASectioningClick
      end
    end
    object MMTools: TMenuItem
      ...
      object MMTDarkCurrentAdquisition: TMenuItem
        Caption = 'Captura Corriente Oscura'
        OnClick = MMTDarkCurrentAdquisitionClick
      end
    end

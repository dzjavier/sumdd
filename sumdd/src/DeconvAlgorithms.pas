...
procedure LinearLeastSquareNEW(var VecPSF:TVector;
                                   VecImage:TVector;
...
procedure NearestNeighborndNEW(var VecPSF: TVector;
	                             VecImage: TVector;
                               const X,Y,Z:Integer;
                               const C1,C2:Double);


procedure ConstrainedIterativeNEW(var VecPSF: TVector;
		        	  VecImage:TVector;
...
function GlobalSNR(const Data: TVector): Double;
...
//  AssignFile(logfile,'C:\JavierD\Programming\SUMDD3.0\Output\log.txt'); /// directorio en casa
  AssignFile(logfile,GetCurrentDir+'\logCID.txt');
 ...
 FActivityProgress.Show;
 FActivityProgress.PBActivityProgress.Position:=0;
 FActivityProgress.LProgress.Left:=FActivityProgress.Width div 4;
...
procedure WienerFilter2D(const VecPSF: TVector;
                         ...
                         const c:Double);
var
 ImAux,ReAux,OTFAuxRe,OTFAuxIm: TVector;
...
///
 ...
 // Come Back where you belonged
  ...
  except on E: Exception do MessageDlg('The inv FFT',mtError,[mbOk],0);
...
procedure NearestNeighborndNEW(var VecPSF: TVector;
              		             ...
              		             const C1,C2:Double);
var
 ImAux,ReAux,OTFAuxRe,OTFAuxIm,ImaAuxRe,ImaAuxIm:TVector;
 ldn2Vector: array [0..1] of UINT;
...
///////////////////////////////////////////////////////
 ...
 // Come Back where you belonged
   try
    ndim_fft(PDouble(@ImaAuxRe[Counter1-(X*Y)]),PDouble(@ImaAuxIm[Counter1-(X*Y)]),2,PUINT(@ldn2Vector[0]));
   except on E: Exception do  MessageDlg(E.Message,mtWarning, [mbOk], 0);
   end;

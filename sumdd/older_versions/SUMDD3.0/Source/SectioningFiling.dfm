object FSectioning: TFSectioning
  ...
  object PData: TPanel
    ...
    object GBSpecimen: TGroupBox
      ...
      object CBSectioningUp: TCheckBox
        Left = 232
        Top = 252
        Width = 146
        Height = 10
        Caption = 'Mover Platina hacia Arriba'
        TabOrder = 20
        OnClick = CBSectioningUpClick
      end
      object CBSectioningDown: TCheckBox
        Left = 232
        Top = 269
        Width = 146
        Height = 11
        Caption = 'Mover Platina hacia Abajo'
        TabOrder = 21
        OnClick = CBSectioningDownClick
      end
    end

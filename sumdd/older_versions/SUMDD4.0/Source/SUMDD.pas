...
begin
 if not (Manager.VolRaw=nil) then
  begin
   ...
   F3DProjectionRaw.Caption:='Proyección Tridimensional de Datos Crudos';
  ...
  if not(Manager.VolDeconv=nil) then
   begin
    ...
    F3DProjectionDeconv.Caption:='Proyección Tridimensional de Datos Desconvolucionados';
    cDeconv:=0;
    for k:=0 to Manager.ZDim-1 do
     for i:=0 to Manager.YDim-1 do
      for j:=0 to Manager.XDim-1 do
       begin
        if (Manager.VolDeconv[k].Value[j,i]>0) then
         begin

...
type TSignal = array of TComplex;

type TSignal2D = array of TSignal;

type TSignal3D = array of TSignal2D;

type TVector = array of Double;

type TSectioningData = record // Tipo de dato generado para guardar informacion acerca del
 ...
 TRawData = array of TByteMap; // Se va a utilzar para tener el volumen
